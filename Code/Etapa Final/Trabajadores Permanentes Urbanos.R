#MODELOS TRABAJADORES PERMANENTES URBANOS
...
------------------------------------------------------------------------------------------------------------------
#11. Modelo: Salario base de cotización diario de trabajadores permanentes urbanos asegurados (continua, sal_bas_cotdi_tpu) respecto a Masa salarial de trabajadores asegurados (continua, masa_sal_ta)
...
#Modelo
#Lineal
m11 <- lm(sal_bas_cotdi_tpu ~ masa_sal_ta, asgChi_tpu)
m11
summary(m11)
#Cuadrático
masa_sal_ta2 <- asgChi_tpu$masa_sal_ta^2
m112 <- lm(sal_bas_cotdi_tpu ~ masa_sal_ta + masa_sal_ta2, asgChi_tpu)
m112
summary(m112)
#Cúbico
masa_sal_ta3 <- asgChi_tpu$masa_sal_ta^3
m113 <- lm(sal_bas_cotdi_tpu ~ masa_sal_ta + masa_sal_ta2 + masa_sal_ta3, asgChi_tpu)
m113
summary(m113)
#Potencia 4
masa_sal_ta4 <- asgChi_tpu$masa_sal_ta^4
m114 <- lm(sal_bas_cotdi_tpu ~ masa_sal_ta + masa_sal_ta2 + masa_sal_ta3 + masa_sal_ta4, asgChi_tpu)
m114
summary(m124)
...
------------------------------------------------------------------------------------------------------------------
#12. Modelo: Salario base de cotización diario de trabajadores permanentes urbanos asegurados (continua, sal_bas_cotdi_tpu) respecto a Sexo (categórica, sexo) y Tamaño de registro patronal (categórica, tama.o_patron)
...
#Modelo
#Lineal
m12 <- lm(sal_bas_cotdi_tpu ~ sexo_bin + tama.o_patron_num, asgChi_tpu)
m12
summary(m12)
